...
def custom_dataset():
    ...
    train_file = "/content/drive/MyDrive/helicopter_data/train.arff"
    test_file  = "/content/drive/MyDrive/helicopter_data/test.arff"
...
parser.add_argument("--l1_addon_coeff", type=float, help="L1 regularization coefficient for feature importance layer", required=False, default=5e-5)
parser.add_argument("--l1_coeff", type=float, help="L1 regularization coefficient", required=False, default=1e-4)
parser.add_argument("--clst_coeff", type=float, help="Cluster separation coefficient", required=False, default=0.10)
parser.add_argument("--sep_coeff", type=float, help="Separation coefficient", required=False, default=-0.0675)
    ...
    try:
        ...
        if encoder_pretraining:
            if ae_save_path.exists():
                ...
                train_autoencoder(autoencoder, train_loader, test_loader,
